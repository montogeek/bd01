...
{	
	...
	wp_enqueue_style('source-sans', 'http://fonts.googleapis.com/css?family=Source+Sans+Pro',array(), '');
	wp_enqueue_style('arvo', 'http://fonts.googleapis.com/css?family=Arvo',array(), '');
